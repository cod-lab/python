...
def gameloop():
    ...
    while exitgame != True:
        if gameover == True:
            #w.PlaySound("The Rowdy Tavern.wav", w.SND_ASYNC | w.SND_ALIAS )                #gives sound effects in windows
            #ps('The Rowdy Tavern.mp3',True)
            ...
            if abs(snake_x - food_x)<10 and abs(snake_y - food_y)<10:
                ...
                w.PlaySound("Flashpoint001a.flac", w.SND_ASYNC | w.SND_ALIAS )                #gives sound effects in windows
                score += 10
                snake_length += 2
                food_x = r.randint(0,box_width)
                food_y = r.randint(0,box_height)
