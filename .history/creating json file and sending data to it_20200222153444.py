...
class person():
    ...
    def fn2(self):
        ...
        if z!=self.country:
            ...
            #getting length of the dictionary ny calling 'update_json' fn, using reading fn to read the given json file to get the length of dictionary stored in that file
