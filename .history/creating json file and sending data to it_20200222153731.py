...
class person():
    ...
    def fn2(self):
        ...
        if z!=self.country:
            ...
            #getting length of the dictionary by calling 'update_json' fn, using 'reading' fn to read the given json file to get the length of dictionary stored in that file
            
            #self.list1={}
            self.list1[self.n]={x:z}
            
            self.update_json('outsiders.json')  #-->
            #calling 'update_json' fn to write data into json file, using 'write' fn to write data to the given json file
    ...
    def update_json(self,file):
        ...
        return len(temp)                                    #gettingcount no. of keys in dict and add into n
