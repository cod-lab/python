...
for enemy in enemies:
    t.register_shape("Anubis.gif")
    enemy.shape("Anubis.gif")
    #enemy.shapesize(0.0001,0.0001)
    #enemy.color("red")
    enemy.penup()
    enemy.speed(0)
...
#bullet ui
bullet = t.Turtle()
t.register_shape("Death_Star.gif")
#bullet.color("yellow")
bullet.shape("Death_Star.gif")
bullet.penup()
bullet.speed(0)
...
def bfire():
    ...
    if bullet_state == "readytofire":
        winsound.PlaySound("laser1.wav", winsound.SND_ASYNC)                #gives sound effects in windows
        x = player.xcor()
        y = player.ycor() + 10
...
while True:
    for enemy in enemies:
        ...
        if collision(bullet,enemy):
            #sound
            winsound.PlaySound("8bit_bomb_explosion.wav", winsound.SND_ASYNC)                #gives sound effects in windows
