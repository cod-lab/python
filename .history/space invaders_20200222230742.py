...
#bullet movement
bullet_spd = 20
''' there r 2 states of bullet - ready state, fire state, because bullet will be fired only when earlier bullet is disappeared i.e bullet comes in ready state from fire state again'''
bullet_state = "ready"
def bfire():
