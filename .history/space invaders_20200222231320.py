...
''' there r 2 states of bullet - ready state, fire state, because bullet will be fired only when earlier bullet is disappeared i.e when bullet comes in ready state from fire state again'''
bullet_state = "ready"
def bfire():
    global bullet_state                #we make this global so that any changes made here will also change the original variable
