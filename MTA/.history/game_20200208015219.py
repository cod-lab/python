...
def text_screen(text1,text2,color,x1,y1,x2,y2):
    screen_text1 = font.render(text1,True,color)
    screen_text2 = font.render(text2,True,color)
    gamewindow.blit(screen_text1,screen_text2,[x1,y1],[x2,y2])
    pass
...
while not exitgame:
    ...
    text_screen("score:" + str(score),red,400,5)
    text_screen("sNaKe GaMe",green,5,5)
